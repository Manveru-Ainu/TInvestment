...
/*let estatura = parseFloat(prompt("para calcular tu Indice de masa corporal, ingresa tu estatura en metros"))
let peso = parseFloat(prompt("ingresa tu peso en kg"));   

let respDatos = prompt("estatura ingresada " + estatura + "kg, "+ "peso ingresado " + peso + "kg "+ "¿correcto?");
    if (respDatos == "si")
    {
        alert ("Tu indice de masa corporal es " + (peso/(estatura*estatura)));
    }
    else
    {
        let estatura = parseFloat(prompt("introduce de nuevo estatura en metros"));
        let peso = parseFloat(prompt("introduce de nuevo peso en kg"));
        alert ("Tu indice de masa corporal es " + (peso/(estatura*estatura)));   
    }
        

let tabla = parseInt(prompt("Introduce la tabla de multiplicar que quieras"))
let rango = parseInt(prompt("Comienza en cero, ¿hasta qué numero deseas multiplicar?"))
let num = 0;
let valor = 0;
    ...
    {
        valor=tabla*num;
        document.write(+ tabla + " * "+ num + " = "+valor+"<br>")
        console.log(`${tabla} X ${num} = ${valor}`);
        num++
}   while
        (num<=rango);*/
